...
if __name__ == "__main__":
    ...
    game.add_available_button(vzd.Button.MOVE_FORWARD_BACKWARD_DELTA, 50)
    game.add_available_button(vzd.Button.MOVE_LEFT_RIGHT_DELTA, 5)
    game.add_available_button(vzd.Button.TURN_LEFT_RIGHT_DELTA, 180)
    game.add_available_button(vzd.Button.LOOK_UP_DOWN_DELTA)
            ...
            if max > 20:
                ...
                if flag == 1:
                    ...
                    if get_distance_to_next(node[0], node[1], current[0], current[1]) < 50:
                        if direction[1] * 2 < depthmap.shape[1]:
                            print("Left")
                            action[0] = 10
                            action[1] = move_left_right
                            action[2] = -8
